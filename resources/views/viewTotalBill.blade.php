...
<body>
    @include('header', ['title' => "List Bills"])
                                    ...
                                    <div class="card redial-border-light redial-shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <table class="table table-dark table-hover mb-0 redial-font-weight-500 table-responsive d-md-table">
                                                ...
                                                <td> <a href="{{route('viewBillDetails',['id'=> "$bills->invoice_number",'date'=>"$bills->ordered_date"])}}"><button class="report button2">View Bill</button> </a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                        @else
